...
*/
#define EndianLittleWord(x) ({ uint32_t t = x; (t >> 24) & 0xff | (t >> 8) & 0xff00 | (t << 8) & 0xff00 | (t << 24) & 0xff000000; })
/**
	Converts a number from the machine's byte order to big endian or back.
*/
...
/**
	Converts a number from the machine's byte order to little endian or back.
*/
#define EndianLittleHalf(x) ({ uint16_t t = x; (t >> 8) & 0xff | (t << 8) & 0xff00; })
#elif defined ENDIAN_LITTLE
/**
	Converts a number from the machine's byte order to big endian or back.
*/
#define EndianBigWord(x) ({ uint32_t t = x; (t >> 24) & 0xff | (t >> 8) & 0xff00 | (t << 8) & 0xff0000 | (t << 24) & 0xff000000; })
/**
	Converts a number from the machine's byte order to little endian or back.
*/
...
/**
	Converts a number from the machine's byte order to big endian or back.
*/
#define EndianBigHalf(x) ({ uint16_t t = x; (t >> 8) & 0xff | (t << 8) & 0xff00; })
/**
	Converts a number from the machine's byte order to little endian or back.
*/
